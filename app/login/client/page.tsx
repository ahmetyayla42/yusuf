...
export default function ClientLoginPage() {
  const [state, formAction, pending] = useActionState(loginClient, undefined);
    ...
    <div className="flex min-h-screen items-center justify-center bg-brand-black px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-card">
          <h1 className="text-xl font-bold text-brand-black">Müşteri Girişi</h1>
          <p className="mt-1 text-sm text-brand-gray">
            Firma bilgilerinizle raporlarınıza erişin.
          </p>
